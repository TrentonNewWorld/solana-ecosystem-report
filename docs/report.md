...
_Generated 2026-09-17T15:39:52Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-09-17T15:39:52Z` |
| Sources healthy | 8 of 8 |
| Collection time | 9.17s |
| Snapshots in history | 204 |
| Anomalies flagged | 0 (0 critical) |

## At a glance

- The network is processing **2,552 non-vote TPS** (4,677 TPS including consensus votes) over the last 60.0 minutes, at a mean slot time of **0.317s**.
- **678 active validators** (12 delinquent, holding 0.036% of stake). It takes **18 validators** to control a third of stake — the liveness-halting threshold.
- **SOL at $100.85** (+3.86% over 24h), market cap $59.21B.
- **DeFi TVL $5.85B** (-0.08% 7d, +20.39% 30d), against $15.30B of stablecoins settled on Solana.
...
| Current epoch | 1036 (64.69% complete) |
| Slot | 279,451 of 432,000 in epoch |
| Absolute slot | 447,831,451 |
| Block height | 425,872,607 |
| Lifetime transactions | 549,458,772,650 |
| TPS (now / mean / peak) | 4,499 / 4,677 / 5,256 |
| True TPS, non-vote (now / mean) | 2,351 / 2,552 |
| Slot time (mean / worst) | 0.317s / 0.33s |

Epoch 1036 has **152,549 slots remaining**, about **13h 25m** at the current slot time.
...
| Delinquent stake | 156,395 SOL (0.036%) |
...
| `DHoZJqvvMGvAXw85Lmsob7YwQzFVisYg8HY4rt5BAj6M` | 807 | 447,790,536 |
...
| Metric | Value | Change |
|---|---|---|
| SOL price | $100.85 | +3.86% 24h ↑ |
| Market cap | $59.21B | |
| Spot volume 24h | $3.82B | |
| DeFi TVL | $5.85B | +2.23% 1d / -0.08% 7d / +20.39% 30d |
| TVL 90-day peak | $6.03B | |
| Stablecoin supply (USD peg) | $15.30B | |
| Stablecoin supply (all pegs) | $15.36B | |
| DEX volume 24h | $2.80B | +3.59% 1d |
| DEX volume 7d / 30d | $17.85B / $79.77B | |
| Fees + app revenue 24h | $14.07M | -0.10% 1d |
| Circulating supply | 587,212,048 SOL (92.59% of total) |
...
| Orca DEX | $284.25M | 10.15% |
| Raydium AMM | $236.69M | 8.45% |
...
| Metric | 2026-08-28T06:17:33Z | 2026-09-17T15:39:52Z | Change |
|---|---|---|---|
| SOL price | $107 | $101 | -6.13% |
| DeFi TVL | $5.94B | $5.85B | -1.55% |
| Stablecoin supply | $15.97B | $15.30B | -4.25% |
| DEX volume 24h | $3.63B | $2.80B | -22.90% |
| Mean TPS | 3,288 | 4,677 | +42.27% |
