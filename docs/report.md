...
_Generated 2026-09-09T13:41:30Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-09-09T13:41:30Z` |
| Sources healthy | 8 of 8 |
| Collection time | 12.3s |
| Snapshots in history | 131 |
| Anomalies flagged | 1 (1 critical) |

## At a glance

- The network is processing **2,199 non-vote TPS** (4,324 TPS including consensus votes) over the last 60.0 minutes, at a mean slot time of **0.317s**.
- **678 active validators** (11 delinquent, holding 0.384% of stake). It takes **18 validators** to control a third of stake — the liveness-halting threshold.
- **SOL at $104.02** (+2.01% over 24h), market cap $60.94B.
- **DeFi TVL $5.97B** (+5.59% 7d, +22.84% 30d), against $16.21B of stablecoins settled on Solana.
...
|---|---|---|---|---|
| 🔴 critical | Delinquent stake | 0.384 | 0.014% +/- 0.007% (median of last 130) | Delinquent stake is 0.384%, 49.9 robust standard deviations above its recent median of 0.014% (+2642.9%). |
...
| Current epoch | 1031 (53.90% complete) |
| Slot | 232,827 of 432,000 in epoch |
| Absolute slot | 445,624,827 |
| Block height | 423,668,414 |
| Lifetime transactions | 546,703,213,959 |
| TPS (now / mean / peak) | 4,367 / 4,324 / 5,914 |
| True TPS, non-vote (now / mean) | 2,223 / 2,199 |
| Slot time (mean / worst) | 0.317s / 0.328s |

Epoch 1031 has **199,173 slots remaining**, about **17h 32m** at the current slot time.

## Validator set

| Metric | Value |
|---|---|
| Active / delinquent | 678 / 11 (1.60% delinquent) |
| Total stake | 438,653,505 SOL |
| Delinquent stake | 1,682,540 SOL (0.384%) |
...
| Metric | Value | Change |
|---|---|---|
| SOL price | $104.02 | +2.01% 24h ↑ |
| Market cap | $60.94B | |
| Spot volume 24h | $2.87B | |
| DeFi TVL | $5.97B | +0.89% 1d / +5.59% 7d / +22.84% 30d |
...
| Fees + app revenue 24h | $16.56M | +5.93% 1d |
| Circulating supply | 586,250,466 SOL (92.51% of total) |
...
| Metric | 2026-08-28T06:17:33Z | 2026-09-09T13:41:30Z | Change |
|---|---|---|---|
| SOL price | $107 | $104 | -3.18% |
| DeFi TVL | $5.94B | $5.97B | +0.47% |
| Stablecoin supply | $15.97B | $16.21B | +1.49% |
| DEX volume 24h | $3.63B | $2.71B | -25.37% |
| Mean TPS | 3,288 | 4,324 | +31.52% |
