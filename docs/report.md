...
_Generated 2026-09-19T18:13:09Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-09-19T18:13:09Z` |
| Sources healthy | 8 of 8 |
| Collection time | 7.69s |
| Snapshots in history | 224 |
| Anomalies flagged | 1 (1 critical) |

## At a glance

- The network is processing **2,391 non-vote TPS** (4,905 TPS including consensus votes) over the last 60.0 minutes, at a mean slot time of **0.268s**.
...
- **SOL at $111.15** (-0.93% over 24h), market cap $65.29B.
- **DeFi TVL $6.25B** (+5.85% 7d, +19.23% 30d), against $16.51B of stablecoins settled on Solana.
...
|---|---|---|---|---|
| 🔴 critical | DeFi TVL | 6245223458 | $5,890,389,325 +/- $77,620,295 (median of last 223) | DeFi TVL is $6,245,223,458, 4.6 robust standard deviations above its recent median of $5,890,389,325 (+6.0%). |
...
| Current epoch | 1038 (15.99% complete) |
| Slot | 69,088 of 432,000 in epoch |
| Absolute slot | 448,485,088 |
| Block height | 426,525,868 |
| Lifetime transactions | 550,262,901,822 |
| TPS (now / mean / peak) | 5,093 / 4,905 / 5,780 |
| True TPS, non-vote (now / mean) | 2,546 / 2,391 |
| Slot time (mean / worst) | 0.268s / 0.279s |

Epoch 1038 has **362,912 slots remaining**, about **27h 1m** at the current slot time.
...
| Metric | Value | Change |
|---|---|---|
| SOL price | $111.15 | -0.93% 24h ↓ |
| Market cap | $65.29B | |
| Spot volume 24h | $3.47B | |
| DeFi TVL | $6.25B | +5.90% 1d / +5.85% 7d / +19.23% 30d |
| TVL 90-day peak | $6.25B | |
| Stablecoin supply (USD peg) | $16.51B | |
| Stablecoin supply (all pegs) | $16.57B | |
| DEX volume 24h | $3.54B | +36.44% 1d |
| DEX volume 7d / 30d | $17.70B / $80.96B | |
| Fees + app revenue 24h | $17.46M | +18.99% 1d |
| Circulating supply | 587,367,772 SOL (92.59% of total) |
...
| Metric | 2026-08-28T06:17:33Z | 2026-09-19T18:13:09Z | Change |
|---|---|---|---|
| SOL price | $107 | $111 | +3.45% |
| DeFi TVL | $5.94B | $6.25B | +5.06% |
| Stablecoin supply | $15.97B | $16.51B | +3.35% |
| DEX volume 24h | $3.63B | $3.54B | -2.62% |
| Mean TPS | 3,288 | 4,905 | +49.20% |
