...
_Generated 2026-09-19T16:27:31Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-09-19T16:27:31Z` |
| Sources healthy | 8 of 8 |
| Collection time | 9.2s |
| Snapshots in history | 223 |
| Anomalies flagged | 1 (1 critical) |

## At a glance

- The network is processing **1,974 non-vote TPS** (4,490 TPS including consensus votes) over the last 60.0 minutes, at a mean slot time of **0.268s**.
...
- **SOL at $111.64** (+0.08% over 24h), market cap $65.58B.
- **DeFi TVL $6.25B** (+5.95% 7d, +19.34% 30d), against $16.52B of stablecoins settled on Solana.
...
|---|---|---|---|---|
| 🔴 critical | DeFi TVL | 6250954447 | $5,890,202,211 +/- $77,897,706 (median of last 222) | DeFi TVL is $6,250,954,447, 4.6 robust standard deviations above its recent median of $5,890,202,211 (+6.1%). |
...
| Current epoch | 1038 (10.51% complete) |
| Slot | 45,388 of 432,000 in epoch |
| Absolute slot | 448,461,388 |
| Block height | 426,502,197 |
| Lifetime transactions | 550,232,480,957 |
| TPS (now / mean / peak) | 4,461 / 4,490 / 4,951 |
| True TPS, non-vote (now / mean) | 1,948 / 1,974 |
| Slot time (mean / worst) | 0.268s / 0.274s |

Epoch 1038 has **386,612 slots remaining**, about **28h 46m** at the current slot time.
...
| Metric | Value | Change |
|---|---|---|
| SOL price | $111.64 | +0.08% 24h ↑ |
| Market cap | $65.58B | |
| Spot volume 24h | $3.79B | |
...
| Circulating supply | 587,367,852 SOL (92.59% of total) |
...
| Metric | 2026-08-28T06:17:33Z | 2026-09-19T16:27:31Z | Change |
|---|---|---|---|
| SOL price | $107 | $112 | +3.91% |
| DeFi TVL | $5.94B | $6.25B | +5.15% |
| Stablecoin supply | $15.97B | $16.52B | +3.41% |
| DEX volume 24h | $3.63B | $3.54B | -2.62% |
| Mean TPS | 3,288 | 4,490 | +36.59% |
