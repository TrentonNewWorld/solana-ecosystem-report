...
_Generated 2026-08-28T06:33:42Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-08-28T06:33:42Z` |
| Sources healthy | 7 of 7 |
| Collection time | 7.06s |
| Snapshots in history | 11 |
...
- **SOL at $107.25** (+6.14% over 24h), market cap $62.64B.
...
| Current epoch | 1023 (79.84% complete) |
| Slot | 344,906 of 432,000 in epoch |
| Absolute slot | 442,280,906 |
| Block height | 420,329,081 |
| Lifetime transactions | 542,648,727,096 |
| TPS (now / mean / peak) | 3,443 / 3,338 / 3,718 |
| True TPS, non-vote (now / mean) | 1,584 / 1,456 |
| Slot time (mean / worst) | 0.365s / 0.373s |

Epoch 1023 has **87,094 slots remaining**, about **8h 49m** at the current slot time.
...
| Metric | Value | Change |
|---|---|---|
| SOL price | $107.25 | +6.14% 24h ↑ |
| Market cap | $62.64B | |
| Spot volume 24h | $6.87B | |
...
| Metric | 2026-08-28T06:17:33Z | 2026-08-28T06:33:42Z | Change |
|---|---|---|---|
| SOL price | $107 | $107 | -0.18% |
| DeFi TVL | $5.94B | $5.94B | +0.00% |
| Stablecoin supply | $15.97B | $15.98B | +0.01% |
| DEX volume 24h | $3.63B | $3.63B | +0.00% |
| Mean TPS | 3,288 | 3,338 | +1.55% |
