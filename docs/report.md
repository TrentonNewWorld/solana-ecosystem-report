...
_Generated 2026-09-05T19:00:58Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-09-05T19:00:58Z` |
| Sources healthy | 8 of 8 |
| Collection time | 8.12s |
| Snapshots in history | 98 |
| Anomalies flagged | 0 (0 critical) |

## At a glance

- The network is processing **1,318 non-vote TPS** (3,448 TPS including consensus votes) over the last 60.0 minutes, at a mean slot time of **0.315s**.
...
- **SOL at $103.91** (+2.21% over 24h), market cap $60.84B.
- **DeFi TVL $5.91B** (+0.75% 7d, +23.07% 30d), against $16.30B of stablecoins settled on Solana.
...
| Current epoch | 1029 (15.27% complete) |
| Slot | 65,955 of 432,000 in epoch |
| Absolute slot | 444,593,955 |
| Block height | 422,638,373 |
| Lifetime transactions | 545,460,035,216 |
| TPS (now / mean / peak) | 3,392 / 3,448 / 4,321 |
| True TPS, non-vote (now / mean) | 1,276 / 1,318 |
| Slot time (mean / worst) | 0.315s / 0.33s |

Epoch 1029 has **366,045 slots remaining**, about **32h 1m** at the current slot time.
...
| Metric | Value | Change |
|---|---|---|
| SOL price | $103.91 | +2.21% 24h ↑ |
| Market cap | $60.84B | |
| Spot volume 24h | $2.32B | |
| DeFi TVL | $5.91B | -0.09% 1d / +0.75% 7d / +23.07% 30d |
...
| Circulating supply | 585,445,738 SOL (92.41% of total) |
...
| Manifest Trade | $123.44M | 6.56% |
| Orca DEX | $114.75M | 6.10% |
...
| Metric | 2026-08-28T06:17:33Z | 2026-09-05T19:00:58Z | Change |
|---|---|---|---|
| SOL price | $107 | $104 | -3.29% |
| DeFi TVL | $5.94B | $5.91B | -0.52% |
| Stablecoin supply | $15.97B | $16.30B | +2.06% |
| DEX volume 24h | $3.63B | $1.88B | -48.19% |
| Mean TPS | 3,288 | 3,448 | +4.88% |
