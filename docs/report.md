...
_Generated 2026-09-20T19:26:13Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-09-20T19:26:13Z` |
| Sources healthy | 8 of 8 |
| Collection time | 7.72s |
| Snapshots in history | 234 |
| Anomalies flagged | 1 (0 critical) |

## At a glance

- The network is processing **2,176 non-vote TPS** (4,684 TPS including consensus votes) over the last 60.0 minutes, at a mean slot time of **0.268s**.
- **676 active validators** (14 delinquent, holding 0.009% of stake). It takes **18 validators** to control a third of stake — the liveness-halting threshold.
- **SOL at $109.88** (-1.04% over 24h), market cap $64.54B.
- **DeFi TVL $6.17B** (+4.47% 7d, +15.47% 30d), against $15.44B of stablecoins settled on Solana.
...
|---|---|---|---|---|
| 🟠 warning | DeFi TVL | 6171152011 | $5,895,037,123 +/- $73,497,546 (median of last 233) | DeFi TVL is $6,171,152,011, 3.8 robust standard deviations above its recent median of $5,895,037,123 (+4.7%). |
...
| Current epoch | 1038 (94.80% complete) |
| Slot | 409,528 of 432,000 in epoch |
| Absolute slot | 448,825,528 |
| Block height | 426,866,197 |
| Lifetime transactions | 550,650,684,713 |
| TPS (now / mean / peak) | 4,935 / 4,684 / 5,169 |
| True TPS, non-vote (now / mean) | 2,398 / 2,176 |
| Slot time (mean / worst) | 0.268s / 0.278s |

Epoch 1038 has **22,472 slots remaining**, about **1h 40m** at the current slot time.
...
| Delinquent stake | 39,733 SOL (0.009%) |
...
| Metric | Value | Change |
|---|---|---|
| SOL price | $109.88 | -1.04% 24h ↓ |
| Market cap | $64.54B | |
| Spot volume 24h | $3.09B | |
| DeFi TVL | $6.17B | -2.13% 1d / +4.47% 7d / +15.47% 30d |
| TVL 90-day peak | $6.31B | |
| Stablecoin supply (USD peg) | $15.44B | |
...
| Circulating supply | 587,366,547 SOL (92.59% of total) |
...
| Raydium AMM | $258.09M | 8.98% |
| HumidiFi | $228.88M | 7.96% |
| Orca DEX | $203.66M | 7.08% |
...
| Metric | 2026-08-28T06:17:33Z | 2026-09-20T19:26:13Z | Change |
|---|---|---|---|
| SOL price | $107 | $110 | +2.27% |
| DeFi TVL | $5.94B | $6.17B | +3.81% |
| Stablecoin supply | $15.97B | $15.44B | -3.32% |
| DEX volume 24h | $3.63B | $2.88B | -20.83% |
| Mean TPS | 3,288 | 4,684 | +42.46% |
