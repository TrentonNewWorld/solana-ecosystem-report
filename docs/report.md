...
_Generated 2026-09-06T08:08:12Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-09-06T08:08:12Z` |
| Sources healthy | 8 of 8 |
| Collection time | 9.07s |
| Snapshots in history | 103 |
| Anomalies flagged | 0 (0 critical) |

## At a glance

- The network is processing **1,234 non-vote TPS** (3,360 TPS including consensus votes) over the last 60.0 minutes, at a mean slot time of **0.316s**.
- **675 active validators** (18 delinquent, holding 0.033% of stake). It takes **18 validators** to control a third of stake — the liveness-halting threshold.
- **SOL at $105.24** (+2.95% over 24h), market cap $61.62B.
...
| Current epoch | 1029 (49.87% complete) |
| Slot | 215,434 of 432,000 in epoch |
| Absolute slot | 444,743,434 |
| Block height | 422,787,808 |
| Lifetime transactions | 545,623,150,779 |
| TPS (now / mean / peak) | 3,305 / 3,360 / 4,287 |
| True TPS, non-vote (now / mean) | 1,165 / 1,234 |
| Slot time (mean / worst) | 0.316s / 0.324s |

Epoch 1029 has **216,566 slots remaining**, about **19h 0m** at the current slot time.
...
| Delinquent stake | 144,064 SOL (0.033%) |
...
|---|---|---|
| `ACCRENAtboR1MyyoiPvwNZNkjt1GcLARrACh6hZXdddF` | 65,065 | 444,728,200 |
...
| Circulating supply | 585,445,306 SOL (92.41% of total) |
...
| Metric | 2026-08-28T06:17:33Z | 2026-09-06T08:08:12Z | Change |
|---|---|---|---|
| SOL price | $107 | $105 | -2.05% |
| DeFi TVL | $5.94B | $5.92B | -0.33% |
| Stablecoin supply | $15.97B | $16.35B | +2.37% |
| DEX volume 24h | $3.63B | $1.96B | -46.02% |
| Mean TPS | 3,288 | 3,360 | +2.20% |
