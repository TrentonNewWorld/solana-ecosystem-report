...
_Generated 2026-09-05T07:52:12Z from live public sources. No API keys, no third-party packages._

| | |
|---|---|
| Snapshot | `2026-09-05T07:52:12Z` |
| Sources healthy | 8 of 8 |
| Collection time | 11.16s |
| Snapshots in history | 93 |
| Anomalies flagged | 0 (0 critical) |

## At a glance

- The network is processing **1,016 non-vote TPS** (3,145 TPS including consensus votes) over the last 60.0 minutes, at a mean slot time of **0.316s**.
...
- **SOL at $102.26** (-1.43% over 24h), market cap $59.86B.
- **DeFi TVL $5.85B** (-0.31% 7d, +21.77% 30d), against $16.25B of stablecoins settled on Solana.
- **$1.85B of DEX volume in 24h** across 121 protocols, generating $9.54M in fees.
...
| Current epoch | 1028 (85.79% complete) |
| Slot | 370,626 of 432,000 in epoch |
| Absolute slot | 444,466,626 |
| Block height | 422,511,383 |
| Lifetime transactions | 545,328,454,603 |
| TPS (now / mean / peak) | 2,948 / 3,145 / 3,352 |
| True TPS, non-vote (now / mean) | 900 / 1,016 |
| Slot time (mean / worst) | 0.316s / 0.333s |

Epoch 1028 has **61,374 slots remaining**, about **5h 23m** at the current slot time.
...
| `mrgn4t2JabSgvGnrCaHXMvz8ocr4F52scsxJnkQMQsQ` | 20,297 | 444,464,406 |
...
| Metric | Value | Change |
|---|---|---|
| SOL price | $102.26 | -1.43% 24h ↓ |
| Market cap | $59.86B | |
| Spot volume 24h | $3.05B | |
| DeFi TVL | $5.85B | -1.14% 1d / -0.31% 7d / +21.77% 30d |
...
| Fees + app revenue 24h | $9.54M | -19.33% 1d |
| Circulating supply | 585,359,683 SOL (92.41% of total) |

### DEX volume by protocol (24h)

| Protocol | Volume 24h | Share of chain |
|---|---|---|
| PumpSwap | $310.67M | 16.82% |
| BisonFi | $232.51M | 12.59% |
| Orca DEX | $228.55M | 12.37% |
| Meteora DLMM | $180.66M | 9.78% |
| Manifest Trade | $155.30M | 8.41% |
...
| Metric | 2026-08-28T06:17:33Z | 2026-09-05T07:52:12Z | Change |
|---|---|---|---|
| SOL price | $107 | $102 | -4.82% |
| DeFi TVL | $5.94B | $5.85B | -1.57% |
| Stablecoin supply | $15.97B | $16.25B | +1.73% |
| DEX volume 24h | $3.63B | $1.85B | -49.14% |
| Mean TPS | 3,288 | 3,145 | -4.34% |
